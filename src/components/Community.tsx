        ...
        <div className="max-w-3xl mx-auto bg-gray-800/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700">
          ...
          <div className="mt-8 border-t border-gray-700 pt-8">
            ...
            <p className="text-gray-400 text-center">
              MemeX, founded on January 4, 2025, was immediately released to the community, who then formed the MemeX ARMY. In this short time, MemeX has surpassed 340,000+ holders. Join the MemeX ARMY community now!
            </p>
